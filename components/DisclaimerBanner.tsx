...
export default function DisclaimerBanner() {
  return (
    <div
      className="border-2 border-kansho-red/30 bg-kansho-red/[0.03] px-4 py-3 sm:px-6 sm:py-4 text-xs sm:text-sm leading-relaxed tracking-wide"
      role="alert"
    >
      <p className="text-kansho-red font-bold text-xs sm:text-sm tracking-[0.15em] mb-2">
        ⚠ WARNING: AUTHORIZED USE ONLY
      </p>
      <p className="text-kansho-black/80 text-[11px] sm:text-xs leading-relaxed">
